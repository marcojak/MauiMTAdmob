    ...
    public partial class MainPage : ContentPage
    {
        ...
        void SetEvents()
        {
            if (_shouldSetEvents)
            {
                ...
                CrossMauiMTAdmob.Current.OnInterstitialImpression += Current_OnInterstitialImpression;
                CrossMauiMTAdmob.Current.OnInterstitialClicked += Current_OnInterstitialClicked;
