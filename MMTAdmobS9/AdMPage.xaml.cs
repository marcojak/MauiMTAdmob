...
public partial class AdMPage : ContentPage
    {
        ...
        public string INTERSTITIALID = DeviceInfo.Platform == DevicePlatform.Android ? "/21775744923/example/interstitial" : "ca-app-pub-3940256099942544/1033173712";
        public string REWARDEDID = DeviceInfo.Platform == DevicePlatform.Android ? "/21775744923/example/rewarded" : "ca-app-pub-3940256099942544/5224354917";
        public string REWARDINTERSTITIALID = DeviceInfo.Platform == DevicePlatform.Android ? "/21775744923/example/rewarded-interstitial" : "ca-app-pub-3940256099942544/5354046379";
        ...
        public AdMPage()
        {
            ...
            CrossMauiMTAdmob.Current.UseAdManagerForNativeAds = true;
        }
        ...
        {
            CrossMauiMTAdmob.Current.LoadAdManagerInterstitial(INTERSTITIALID);
        }

        private void ShowInterstitial_OnClicked(object sender, EventArgs e)
        {
            CrossMauiMTAdmob.Current.ShowAdManagerInterstitial();
        }

		private void IsLoadedInterstitial_OnClicked(object sender, EventArgs e)
		{
			myLabel.Text = "Interstitial loaded: " + CrossMauiMTAdmob.Current.IsAdManagerInterstitialLoaded().ToString();
		}

		private void GetNumOfLoadedInterstitials(object sender, EventArgs e)
		{
			myLabel.Text = "Loaded Interstitials: " + CrossMauiMTAdmob.Current.GetNumberOfAdManagerInterstitialsLoaded().ToString();
		}

		private void EmptyInterstitialList(object sender, EventArgs e)
		{
			CrossMauiMTAdmob.Current.EmptyAdManagerInterstitialAdsList();
		}

		private void LoadReward_OnClicked(object sender, EventArgs e)
        {
            CrossMauiMTAdmob.Current.LoadAdManagerRewarded(REWARDEDID);
        }

        private void ShowReward_OnClicked(object sender, EventArgs e)
        {
            CrossMauiMTAdmob.Current.ShowAdManagerRewarded();
        }

        private void IsRewardLoaded_OnClicked(object sender, EventArgs e)
        {
            myLabel.Text = "Rewarded loaded: " + CrossMauiMTAdmob.Current.IsAdManagerRewardedLoaded().ToString();
        }

		private void GetNumOfLoadedRewarded(object sender, EventArgs e)
		{
			myLabel.Text = "Loaded Rewarded: " + CrossMauiMTAdmob.Current.GetNumberOfAdManagerRewardedLoaded().ToString();
		}

		private void EmptyRewardedList(object sender, EventArgs e)
		{
			CrossMauiMTAdmob.Current.EmptyAdManagerRewardedAdsList();
		}

		private void LoadRewardInterstitial_OnClicked(object sender, EventArgs e)
        {
            CrossMauiMTAdmob.Current.LoadAdManagerRewardInterstitial(REWARDINTERSTITIALID);
        }

        private void ShowRewardInterstitial_OnClicked(object sender, EventArgs e)
        {
            CrossMauiMTAdmob.Current.ShowAdManagerRewardInterstitial();
        }

        private void IsRewardLoadedInterstitial_OnClicked(object sender, EventArgs e)
        {
            myLabel.Text = "Rewarded Interstitial loaded: " + CrossMauiMTAdmob.Current.IsAdManagerRewardInterstitialLoaded().ToString();
        }

		private void EmptyRewardedInterstitialList(object sender, EventArgs e)
		{
			CrossMauiMTAdmob.Current.EmptyAdManagerRewardInterstitialAdsList();
		}

		private void GetNumOfLoadedRewardedInterstitial(object sender, EventArgs e)
		{
			myLabel.Text = "Loaded Rewarded Interstitial: " + CrossMauiMTAdmob.Current.GetNumberOfAdManagerRewardInterstitialsLoaded().ToString();
		}
