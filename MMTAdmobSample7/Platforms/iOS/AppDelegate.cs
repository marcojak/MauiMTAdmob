...
namespace MMTAdmobSample7
{
    ...
    public class AppDelegate : MauiUIApplicationDelegate
    {
        ...
        public AppDelegate()
        {
            ...
            CrossMauiMTAdmob.Current.Init(license, NATIVEADS_AD_UNIT_ID, OPENADS_AD_UNIT_ID, areOpenAdsEnabled, false, deviceId, Plugin.MauiMTAdmob.Extra.DebugGeography.DEBUG_GEOGRAPHY_EEA);
